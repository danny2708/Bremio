...
are merged into `main`. Sprint 3 tasks T1–T2 are implemented on
`sprint/efficiency-s3`; T3–T4 and Sprint 4 remain open. Sprint 5 is still open:
...
claimed. Current Windows gates pass `release:check` (359 tests) and
