...
typechecks, runs 359 tests, builds, packs, installs into a clean temporary
...
evidence is insufficient. Net-gain computation and the calibrated pre-task
cost kill-switch are implemented; stats presentation, controlled pair
